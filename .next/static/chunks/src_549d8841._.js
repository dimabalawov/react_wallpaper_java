...
"[project]/src/app/printings/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": ()=>PrintingsPage,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$CatalogFilters$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/CatalogFilters.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function PrintingsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PrintingsPage.useEffect": ()=>{
            ...
            fetch("http://localhost:8080/printings?".concat(params.toString())).then({
                "PrintingsPage.useEffect": (res)=>{
                    if (!res.ok) throw new Error("Помилка завантаження");
                    return res.json();
                }
            }["PrintingsPage.useEffect"]).then({
                "PrintingsPage.useEffect": (data)=>{
                    var _data_products, _data_products1;
                    if (data.availableCategories && categories.length === 0) {
                        setCategories(data.availableCategories);
                    }
                    const content = ((_data_products = data.products) === null || _data_products === void 0 ? void 0 : _data_products.content) || data.content || [];
                    const pages = ((_data_products1 = data.products) === null || _data_products1 === void 0 ? void 0 : _data_products1.totalPages) || data.totalPages || 1;
                    setProducts(content);
                    setTotalPages(pages);
                }
            }["PrintingsPage.useEffect"]).catch({
                "PrintingsPage.useEffect": (err)=>setError(err.message)
            }["PrintingsPage.useEffect"]).finally({
                "PrintingsPage.useEffect": ()=>setLoading(false)
            }["PrintingsPage.useEffect"]);
        }
    }["PrintingsPage.useEffect"], [
        page,
    ...
    const handlePageChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PrintingsPage.useCallback[handlePageChange]": (event, value)=>{
            setPage(value);
            window.scrollTo({
                top: 0,
                behavior: "smooth"
    ...
    }["PrintingsPage.useCallback[handlePageChange]"], []);
    const handleCategoryClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PrintingsPage.useCallback[handleCategoryClick]": (categoryId)=>{
            setSelectedCategory({
                "PrintingsPage.useCallback[handleCategoryClick]": (prev)=>prev === categoryId ? null : categoryId
            }["PrintingsPage.useCallback[handleCategoryClick]"]);
            setPage(1);
        }
    }["PrintingsPage.useCallback[handleCategoryClick]"], []);
    const handleSearchChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PrintingsPage.useCallback[handleSearchChange]": (value)=>{
            setSearchTerm(value);
            setPage(1);
        }
    }["PrintingsPage.useCallback[handleSearchChange]"], []);
    const handleFilterUpdate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PrintingsPage.useCallback[handleFilterUpdate]": (newFilters)=>{
            setExtraFilters(newFilters);
            setPage(1);
        }
    }["PrintingsPage.useCallback[handleFilterUpdate]"], []);
    const paginationSx = {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$CategorySidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        fileName: "[project]/src/app/printings/page.tsx",
                        lineNumber: 106,
                        columnNumber: 9
                    }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                        ...
                        children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: products.length > 0 ? products.map((product)=>{
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ProductPreview$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    title: product.name,
                                    imageUrl: ((_product_image = product.image) === null || _product_image === void 0 ? void 0 : _product_image.startsWith("/")) ? "http://localhost:8080".concat(product.image) : product.image,
                                    code: product.article,
                                    price: "".concat((_product_salePrice = product.salePrice) !== null && _product_salePrice !== void 0 ? _product_salePrice : product.basePrice, " грн"),
                                    oldPrice: product.salePrice ? "".concat(product.basePrice, " грн") : undefined,
                                    slug: product.slug,
                                    basePath: "/printings"
                                }, product.id, false, {
                                    fileName: "[project]/src/app/printings/page.tsx",
                                ...
                                children: "За вашим запитом нічого не знайдено"
                            }, void 0, false, {
                                fileName: "[project]/src/app/printings/page.tsx",
                                lineNumber: 168,
                                columnNumber: 17
                    ...
                    totalPages > 1 && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(PrintingsPage, "Seoy9f/nzQKzRmq6GMOv7fWONI0=");
_c = PrintingsPage;
var _c;
__turbopack_context__.k.register(_c, "PrintingsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_549d8841._.js.map