...
const ProductClient = (param)=>{
    ...
    const handleAddToCart = ()=>{
        var _product_image;
        const options = [];
        if (premium) options.push({
            label: "Друк преміум",
            price: 10
        });
        if (glue) options.push({
            label: "Клей",
            price: 129
        });
        if (laminate) options.push({
            label: "Ламінування",
            price: 10
        });
        addToCart({
            ...
            size: "".concat(width, "см x ").concat(height, "см"),
            width,
            height,
...
_s(ProductClient, "+3INtUn9+hWAYpfQ+g9U9CpAYiM=", false, function() {
    return [
...
//# sourceMappingURL=_e6472fb1._.js.map