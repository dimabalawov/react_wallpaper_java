                            ...
                            const formattedOrders = rawData.map({
                                "UserPage.useEffect.fetchOrders.formattedOrders": (order)=>{
                                    ...
                                    const calculatedTotal = items.reduce({
                                        "UserPage.useEffect.fetchOrders.formattedOrders.calculatedTotal": (acc, item)=>acc + item.totalPrice
                                    }["UserPage.useEffect.fetchOrders.formattedOrders.calculatedTotal"], 0);
                                    return {
                                        id: order.id,
